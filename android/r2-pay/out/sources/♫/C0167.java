...
public class C0167 {
    ...
    public static File m810(Context context) {
    ...
    public static java.nio.ByteBuffer m813(java.io.File r7) {
        /*
        ...
        L_0x0025:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: ♫.C0167.m813(java.io.File):java.nio.ByteBuffer");
    }
    ...
    /* renamed from: θ  reason: contains not printable characters */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.nio.ByteBuffer m812(android.content.Context r10, android.os.CancellationSignal r11, android.net.Uri r12) {
        /*
        ...
        L_0x004c:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: ♫.C0167.m812(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }

    /* renamed from: θ  reason: contains not printable characters */
    public static ByteBuffer m811(Context context, Resources res, int id) {
        File tmpFile = m810(context);
        ByteBuffer byteBuffer = null;
        if (tmpFile == null) {
            return null;
        }
        try {
            if (m815(tmpFile, res, id)) {
                byteBuffer = m813(tmpFile);
            }
            return byteBuffer;
        } finally {
            tmpFile.delete();
    ...
    /* renamed from: θ  reason: contains not printable characters */
    public static boolean m816(File file, InputStream is) {
    ...
    /* renamed from: θ  reason: contains not printable characters */
    public static boolean m815(File file, Resources res, int id) {
        InputStream is = null;
        try {
    ...
    /* renamed from: θ  reason: contains not printable characters */
    public static void m814(Closeable c) {
        if (c != null) {
            try {
                c.close();
            } catch (IOException e) {
